...
android {
    namespace = "com.replog"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.replog"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0.0"
...
dependencies {
    ...
    // Phase 2 Gap 2: needed for androidx.lifecycle.compose.LocalLifecycleOwner
    // (the non-deprecated Compose 1.7 location). Kept on the same 2.8.5 line as
    // the other Lifecycle artifacts for consistency.
