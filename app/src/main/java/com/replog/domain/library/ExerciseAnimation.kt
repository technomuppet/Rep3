...
object ExerciseAnimation {
    ...
    fun clip(ex: Exercise): AnimationClip {
        ...
        return when (ExerciseCoach.familyOf(ex)) {
            ExerciseCoach.Family.SQUAT, ExerciseCoach.Family.LUNGE -> squatClip(hasImplement)
            ExerciseCoach.Family.HINGE -> hingeClip(hasImplement)
            ExerciseCoach.Family.PUSH -> pressClip(hasImplement)
            ExerciseCoach.Family.PULL -> pullClip(hasImplement)
            ExerciseCoach.Family.SHOULDERS -> raiseClip(hasImplement)
            ExerciseCoach.Family.CALVES -> calfClip(hasImplement)
            ExerciseCoach.Family.CORE -> coreClip()
            ExerciseCoach.Family.CARRY -> carryClip(hasImplement)
            ExerciseCoach.Family.CONDITIONING -> conditioningClip()
            ExerciseCoach.Family.GENERIC -> pressClip(hasImplement)
        }
    }
